...
bool SqliteDBManager::createTables()
{
    ...
    if(!query.exec( "CREATE TABLE " TABLE_EXAMPLE " ("
                    ...
                    TABLE_EXAMPLE_TEAM1       " VARCHAR(255)    NOT NULL"
                    TABLE_EXAMPLE_TEAM2       " VARCHAR(255)    NOT NULL"
                    TABLE_EXAMPLE_TIME        " DATE            NOT NULL,"
                    TABLE_EXAMPLE_STADIUM     " VARCHAR(255)    NOT NULL"
                    " )"
                    )){
